...
K_initial = 10
K_latent = 400
MCMC_real_data_rippler = inference_rippler(test_results_real,N,h,gamma,T,seasonal_matrix_G,seasonal_matrix_H,age,sex,sens,spec,theta_start,X_start,covariance_start,nu_0,f,delta,mu,prior_X_0,K,K_initial,K_latent,K_chunk,'../luna/AntiDOTE_Methods/experiments/real_data_rippler/MCMC_output_3',1)