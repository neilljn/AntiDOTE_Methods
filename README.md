...
Contains code and data used for the paper 'Non-centering for discrete-valued state transition models: an application to ESBL-producing _E. coli_ transmission in Malawi', currently on arXiv: _https://arxiv.org/abs/2504.11836_.
